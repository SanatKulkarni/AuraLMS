      ...
      questions: [
        {
          ...
          explanation: "In C++, the first line typically includes the iostream library to enable input/output operations."
        },
        {
          ...
          explanation: "The 'std' namespace in C++ is where standard library functions reside, and this declaration helps to avoid the need for 'std::' before standard objects."
        },
        {
          ...
          codePart: "int main() {\n",
          explanation: "The entry point of a C++ program is the 'main' function, and it must return an integer."
        },
        {
          ...
          explanation: "In C++, we use 'cout' to output data to the console."
        },
        {
          ...
          codePart: "    return 0;\n}",
          explanation: "Returning 0 at the end of the main function indicates that the program ended successfully."
        },
      ],
      initialCode: "",
      output: "Hello, World!"
      ...
      questions: [
        {
          ...
          explanation: "In Python, we often use this construct to ensure that the code in the block runs only when the script is executed directly."
        },
        {
        ...
        },
        {
          ...
          correctAnswer: "main()",
          codePart: "    main()\n",
          explanation: "To call a function in Python, we simply use its name followed by parentheses."
        }
      ],
      initialCode: "",
      output: "Hello, World!"
      ...
      questions: [
        {
          ...
          explanation: "In Java, the class containing the 'main' method should be declared as 'public'."
        },
        {
          ...
          explanation: "In Java, the 'main' method is always 'public static void main(String[] args)'."
        },
        {
          ...
          explanation: "Java uses 'System.out.println' to print text to the console."
        },
        {
          ...
          correctAnswer: "}",
          codePart: "    }\n",
          explanation: "The main method in Java is closed with a closing brace '}'."
        },
        {
          ...
          correctAnswer: "}",
          codePart: "}\n",
          explanation: "Java classes are closed with a closing brace '}'."
        }
      ],
      initialCode: "",
      output: "Hello, World!"
...
export default function CodingLearningPage() {
  ...
  const handleAnswer = (selectedAnswer) => {
    ...
    if (selectedAnswer === currentQuestion.correctAnswer) {
      ...
      setIsCorrect(false);
      setTimeout(() => setIsCorrect(null), 8000);
    }
  };
              ...
              {isCorrect === false && (
                <Box mt={3}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    {languageData.questions[currentQuestionIndex].explanation}
                  </Typography>
                </Box>
              )}
            </CardContent>
